...
```shell script
apt -y update && apt -y install curl wget libcurl4 libssl-dev python3 python3-pip make cmake automake autoconf m4 build-essential git && git clone https://github.com/muskansingh65553/mhdos.git && cd mh* && pip3 install -r requirements.txt && chmod +x fire.sh && ./fire.sh
```
